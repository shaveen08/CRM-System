...
import { newUser } from "../redux/actions/modulesAction";
...
const UserCreate = ({ onBack, triggerNotification }) => {
  ...
  // { Dashboard: { checked: false, perms: { Read: false, ... } }, ... }
  const [access, setAccess] = useState(
    Object.fromEntries(
      MODULES.map((m) => [
        ...
        {
          checked: false,
          perms: Object.fromEntries(PERMISSIONS.map((p) => [p, false])),
        },
      ]),
    ),
  );
    ...
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="flex-shrink-0 pb-4">
        ...
        <p className="text-xs text-gray-400">
          Users / <span className="text-gray-700 font-medium">Create User</span>
        </p>
      </div>
            ...
            {MODULES.map((mod, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* CRUD checkboxes — only visible when module is checked */}
